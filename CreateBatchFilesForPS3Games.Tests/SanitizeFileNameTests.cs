...
public class SanitizeFileNameTests
{
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Grand Theft Auto V");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Game Name (Trial)");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Game Name Demo");
        Assert.Equal("Game Name", result);
    }
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Industrial Game");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Demolition Derby");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Trial");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Demo");
        Assert.Equal("UntitledGame", result);
    }
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Final Fantasy Ii");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Final Fantasy Iii");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Final Fantasy Iv");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Final Fantasy Vi");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Final Fantasy Vii");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Final Fantasy Viii");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Final Fantasy Ix");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Final Fantasy X");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Final Fantasy Xi");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Final Fantasy Xii");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Final Fantasy Xiii");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Final Fantasy Xiv");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Final Fantasy Xv");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Final Fantasy Xvi");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Final Fantasy Xvii");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Final Fantasy Xviii");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Final Fantasy Xix");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Final Fantasy Xx");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Game\u2122");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Game: Subtitle");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Game   With   Spaces");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Game Name . ..");
        Assert.Equal("Game Name", result);
    }
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("CON");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("PRN");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("AUX");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("NUL");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("COM1");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("COM9");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("LPT1");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("LPT9");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("COM10");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Game<Name>With\"Invalid*/\\|?:Chars");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("Game\0Name");
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("");
        Assert.Equal("UntitledGame", result);
    }
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("(Trial) Game (Trial)");
        Assert.Equal("Game", result);
    }
    ...
    {
        var result = new FileNameSanitizer().SanitizeFileName("a");
